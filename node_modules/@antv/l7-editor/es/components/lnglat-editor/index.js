...
export var LngLatEditor = function LngLatEditor() {
  ...
  useEffect(function () {
    ...
    var result = GeoJSON2LngLat(fc);
    if (result !== input) {
      setInput(result);
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [fc, isFocus]);
  var _useDebounceFn = useDebounceFn(function (newInput) {
      var features = LngLat2GeoJson(newInput);
      if (features) {
    ...
    onInputChange = _useDebounceFn.run;

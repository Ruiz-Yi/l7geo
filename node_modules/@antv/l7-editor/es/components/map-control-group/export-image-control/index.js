...
export var ExportImage = function ExportImage() {
  var styles = useStyle();
  ...
  var _useTranslation = useTranslation(),
    t = _useTranslation.t;
  var onExport = function onExport(value) {
    setIsModalOpen(true);
    setImageData(value);
  };
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ExportImageControl, {
    onExport: onExport,

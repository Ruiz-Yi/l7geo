...
export var MapHelper = /*#__PURE__*/function () {
  function MapHelper() {
  ...
  _createClass(MapHelper, [{
    ...
    key: "metersToLngLat",
    value: function metersToLngLat(mx, my) {
    ...
    key: "tileToLngLat",
    value: function tileToLngLat(tx, ty, zoom) {
      var _this$tileToMeters = this.tileToMeters(tx, ty, zoom),
        _this$tileToMeters2 = _slicedToArray(_this$tileToMeters, 2),
        minx = _this$tileToMeters2[0],
        miny = _this$tileToMeters2[1];
    ...
    value: function tileLatLonBounds(tx, ty, zoom) {
      ...
      var _this$metersToLngLat = this.metersToLngLat(bounds[0], bounds[1]),
        _this$metersToLngLat2 = _slicedToArray(_this$metersToLngLat, 2),
        minLat = _this$metersToLngLat2[0],
        minLon = _this$metersToLngLat2[1];
      var _this$metersToLngLat3 = this.metersToLngLat(bounds[2], bounds[3]),
        _this$metersToLngLat4 = _slicedToArray(_this$metersToLngLat3, 2),
        maxLat = _this$metersToLngLat4[0],
        maxLon = _this$metersToLngLat4[1];
